 ...
 * @returns 筛选结果
 */
export function filterToolsByMainAgent(options: ToolFilterOptions): ToolFilterResult {
 ...
 * @returns 筛选后的工具列表
 */
export function filterTools(tools?: ChatCompletionTool[]): ChatCompletionTool[] {
