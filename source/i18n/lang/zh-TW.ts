...
export const zhTW: TranslationKeys = {
	...
	helpPanel: {
		...
		toggleYolo: 'Shift+Tab/Ctrl+Y - 切換 YOLO 模式',
		tipsTitle: '💡 提示:',
	...
	chatScreen: {
		...
		shortcutToggleYolo: '切換 YOLO 模式 (Shift+Tab/Ctrl+Y)',
		// Rollback
	...
	sessionListPanel: {
		...
		loading: '載入中...',
		noResults: '無搜尋結果',
		noConversations: '暫無會話記錄',
		marked: '已標記',
		loadingMore: '載入更多...',
		messages: '訊息',
		searchLabel: '搜尋:',
		searchPlaceholder: '輸入關鍵詞搜尋會話...',
		searching: '搜尋中...',
		navigationHint: '↑↓ 導航 · Enter 選擇 · M 標記 · R 重新命名 · D 刪除',
		moreAbove: '↑ 上方還有更多',
		moreBelow: '↓ 下方還有更多',
		scrollToLoadMore: '捲動載入更多',
		untitled: '未命名會話',
		now: '剛剛',
		renamePrompt: '輸入新名稱(留空使用時間戳):',
		renaming: '重新命名中...',
		renamePlaceholder: '新名稱',
	},
	mcpConfigScreen: {
		manageServices: 'MCP 服務管理',
		manageServicesDesc: '查看和啟用/停用 MCP 服務',
	},
	mcpInfoPanel: {
		title: 'MCP 服務',
		loading: '載入 MCP 服務中...',
