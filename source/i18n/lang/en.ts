...
export const en: TranslationKeys = {
	...
	sessionListPanel: {
		...
		messages: 'Messages',
		searchLabel: 'Search:',
		searchPlaceholder: 'Type to search sessions...',
		searching: 'Searching...',
		navigationHint: '↑↓ Navigate · Enter Select · M Mark · R Rename · D Delete',
		moreAbove: '↑ More above',
		moreBelow: '↓ More below',
		scrollToLoadMore: 'Scroll to load more',
		untitled: 'Untitled Session',
		now: 'Just now',
		renamePrompt: 'Enter new name (leave empty for timestamp):',
		renaming: 'Renaming...',
		renamePlaceholder: 'New name',
	},
	mcpConfigScreen: {
		manageServices: 'Manage MCP Services',
		manageServicesDesc: 'View and enable/disable MCP services',
	},
	mcpInfoPanel: {
		title: 'MCP Services',
