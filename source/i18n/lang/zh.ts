...
export const zh: TranslationKeys = {
	welcome: {
		...
		mainAgentSettingsInfo: '配置主代理的工具权限和系统提示词',
	...
	chatScreen: {
		...
		teamModeActive: '⚐ Team 模式已激活 - 专业规划与协调助手',
		tokens: ' 个token',
		cached: '已缓存',
		newCache: '新缓存',
	},
	...
	mainAgent: {
		...
		instructions: '↑↓: 选择 | Enter: 编辑 | D: 重置 | Esc: 返回',
		reset: {
			success: '{agentName}主代理重置成功',
			failed: '{agentName}主代理重置失败',
		},
		edit: {
			title: '编辑主代理',
			saveSuccess: '{agentName}主代理配置保存成功',
			saveError: '保存失败',
			confirmReset: '确认重置 {agentName} 主代理到默认配置？',
			tools: '工具',
			subAgents: '子代理',
			systemPrompt: '系统提示词',
			name: '代理名称',
	...
	sessionListPanel: {
		...
		messages: '消息',
		searchLabel: '搜索:',
		searchPlaceholder: '输入关键词搜索会话...',
		searching: '搜索中...',
		navigationHint: '↑↓ 导航 · Enter 选择 · M 标记 · R 重命名 · D 删除',
		moreAbove: '↑ 上方还有更多',
		moreBelow: '↓ 下方还有更多',
		scrollToLoadMore: '滚动加载更多',
		untitled: '未命名会话',
		now: '刚刚',
		renamePrompt: '输入新名称(留空使用时间戳):',
		renaming: '重命名中...',
		renamePlaceholder: '新名称',
	},
	mcpConfigScreen: {
		manageServices: 'MCP 服务管理',
		manageServicesDesc: '查看和启用/禁用 MCP 服务',
	},
	mcpInfoPanel: {
		title: 'MCP 服务',
		loading: '加载 MCP 服务中...',
		...
		statusDisabled: '(已禁用)',
		statusFailed: '失败',
		navigationHint: '↑↓ 导航 · Enter 重连 · Tab 切换服务',
		pleaseWait: '请稍候...',
		toolPermissionHint:
	...
	undoManager: {
		...
		undoSuccess:
			'✅ 撤销成功。已撤销 {steps} 次编辑操作,建议使用 filesystem-edit_search 进行单次少量精确编辑并提供更多行的辅助编辑上下文.别一次性改一大片',
